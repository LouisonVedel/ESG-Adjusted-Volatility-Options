...
The codes in 02_Code is intentionally restricted to the scripts corresponding to the established final pipeline. Pilot, superseded, patch, debugging and one-off repair scripts remain in the local thesis working directory and are not part of this clean package.
